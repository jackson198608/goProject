...
work/src$ ../bin/stress "http://bbs.goumin.com/forum-47-2.html" "bbslist" "/tmp/stress.log" "1" 
...
work/src$ ../bin/stress "http://m.goumin.com/ask/list.html" "masklist" "/tmp/stress.log" "1"